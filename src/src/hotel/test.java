...
public class test {
	...
	public static void newhd(Room d) {
		roomlist.add(d);
	}

	public static void newhs1(Room s1) {
		roomlist.add(s1);
	}

	public static void newhs(Room S) {
		roomlist.add(S);
	}

	public static void newhu(Room u) {
		roomlist.add(u);
	}

	public static void newhc(Room c) {
		roomlist.add(c);
	}
